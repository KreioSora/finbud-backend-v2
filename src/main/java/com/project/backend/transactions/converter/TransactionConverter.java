...
public class TransactionConverter {
    ...
    public Transactions createTransactionConverter(TransactionCreateRequest request, User user, SavingsAccount account, SavingsPockets pockets, TransactionCategory category) {
    ...
    public Transactions updateTransactionConverter(TransactionUpdateRequest request, Transactions transaction, SavingsPockets pocket, TransactionCategory category) {
